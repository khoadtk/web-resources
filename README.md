...
- [Phân quyền (Authorization)](authorization.md) — ACL, RBAC, ABAC, ReBAC, policy-as-code + usecase
  - [Deep-dive: Phân quyền trong NestJS](authorization-nestjs.md) — Guard, decorator, CASL, OpenFGA
  - [Deep-dive: OPA](opa.md) — Rego, input/data/policy, sidecar, test luật, Gatekeeper
